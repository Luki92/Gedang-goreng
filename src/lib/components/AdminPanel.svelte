<script>
    ...
    function open(id, title) {
        windowManager.toggle(id, { title, originType: 'bc',
            width: 800,
            height: 600
        });
    }
...
{#if $isAdmin}
    <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-lg bg-[rgba(10,10,15,0.75)] backdrop-blur-[8px] border border-red-500/50 shadow-[0_0_50px_rgba(255,0,0,0.1)] z-50 flex flex-col font-mono text-sm overflow-hidden rounded-lg">
        <!-- Header -->
        ...
        <div class="p-6 grid grid-cols-2 gap-4">
            ...
            <button onclick={() => open('admin-guestbook', 'MODERATION_QUEUE')} class="group relative p-6 border border-[#333] hover:border-yellow-500 bg-[rgba(20,20,30,0.4)] transition-all flex flex-col items-center gap-2">
            ...
            <button onclick={() => open('admin-docs', 'DOCUMENTATION')} class="group relative p-6 border border-[#333] hover:border-purple-500 bg-[rgba(20,20,30,0.4)] transition-all flex flex-col items-center gap-2">
